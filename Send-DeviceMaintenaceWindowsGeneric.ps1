...
$DaysAfterPatchTuesdayToReport = '7'
#$DaysAfterPatchTuesdayToReport = '2'
$DisableReport = ""

$filedate = get-date -Format yyyMMdd
$HTMLFileSavePath = "G:\Scripts\Outfiles\VXOPS_MW_$filedate.HTML"
$CSVFileSavePath = "G:\Scripts\Outfiles\VXOPS_MW_$filedate.csv"
...
New-HTML -TitleText "Patchfönster- Telia Cygate Region Mellan VXOPS" -FilePath $HTMLFileSavePath -ShowHTML -Online {
	
	New-HTMLHeader {
		New-HTMLSection -Invisible {
			New-HTMLPanel -Invisible {
				New-HTMLText -Text "Telia Cygate Region Mellan VXOPS - Patchfönster" -FontSize 35 -Color Darkblue -FontFamily Arial -Alignment center
...
<head>
<meta charset="utf-8">
<title>Server Mainenance Windows - Telia Cygate Region Mellan VXOPS</title>
<style>
