...
$HTMLFileSavePath = "G:\Scripts\Outfiles\$sitecode_UpdateStatus_$filedate.HTML" # Path to attached file
$Logfile = "G:\Scripts\Logfiles\WindowsUpdateScript.log" # Logfile
...
<head>
<meta charset="utf-8">
<title>Uppdatering Status - Kriminalvσrden</title>
<style>
    th {
...
"ALT="Kriminalvσrden logo">
	<p><h1>Uppdatering Status</h1></p> 
	<p>Bifogade fil innehσller Status f÷r servrar:</p>
