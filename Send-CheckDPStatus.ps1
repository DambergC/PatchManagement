...
$mailto4 = 'Tim.Gustavsson@kriminalvarden.se'
...
$Logfile = "G:\Scripts\Logfiles\DPLogfile.log"
...
#########################################################
# Gather Information about Distributionpoints
#########################################################
...
<p><h1>Dagens körning - Kontroll av Distributionspunkter</h1><br>
<p>Följande Distributionspunkter är hanterade idag $today</p>
